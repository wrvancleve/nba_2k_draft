...
PlayerCollection.prototype.populate = function() {
    ...
    this.add("Allen", "Iverson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 90, "Denver Nuggets All-Time", 1);
    ...
    this.add("Alonzo", "Mourning", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 85, "Charlotte Hornets '92-'93", 2);
    this.add("Alonzo", "Mourning", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 89, "Charlotte Hornets All-Time", 2);
    this.add("Alonzo", "Mourning", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 94, "Miami Heat All-Time", 2);
    ...
    this.add("Anderson", "Varejao", [Player.POSITION_CENTER], 80, "Free Agency", 1);
    this.add("Anderson", "Varejao", [Player.POSITION_CENTER], 84, "Cleveland Cavaliers All-Time");
    this.add("Andre", "Drummond", [Player.POSITION_CENTER], 86, "Detroit Pistons All-Time", 1);
    this.add("Andre", "Iguodala", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 84, "Golden State Warriors All-Time", 2);
    this.add("Andre", "Iguodala", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 88, "Philadelphia 76ers All-Time", 2);
    ...
    this.add("Antonio", "Mcdyess", [Player.POSITION_POWER_FORWARD], 88, "Denver Nuggets All-Time", 1);
    ...
    this.add("Arvydas", "Sabonis", [Player.POSITION_CENTER], 86, "Portland Trail Blazers '99-'00", 2);
    this.add("Arvydas", "Sabonis", [Player.POSITION_CENTER], 88, "Portland Trail Blazers All-Time", 2);
    ...
    this.add("Bernard", "King", [Player.POSITION_SMALL_FORWARD], 89, "New York Knicks All-Time", 1);
    this.add("Bernard", "King", [Player.POSITION_SMALL_FORWARD], 93, "Free Agency", 1);
    this.add("Bill", "Bradley", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 80, "New York Knicks '71-'72", 1);
    this.add("Bill", "Bridges", [Player.POSITION_POWER_FORWARD], 80, "Free Agency", 1);
    this.add("Bill", "Cartwright", [Player.POSITION_CENTER], 82, "Free Agency");
    this.add("Bill", "Laimbeer", [Player.POSITION_CENTER], 80, "Detroit Pistons '88-'89", 1);
    this.add("Bill", "Laimbeer", [Player.POSITION_CENTER], 87, "Detroit Pistons All-Time", 1);
    ...
    this.add("Brad", "Davis", [Player.POSITION_POINT_GUARD], 85, "Dallas Mavericks All-Time", 2);
    this.add("Bradley", "Beal", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 89, "Washington Wizards All-Time", 1);
    ...
    this.add("Byron", "Scott", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 84, "Los Angeles Lakers '86-'87", 1);
    this.add("Byron", "Scott", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 86, "Los Angeles Lakers All-Time", 1);
    this.add("C.J.", "McCollum", [Player.POSITION_SHOOTING_GUARD], 86, "Portland Trail Blazers All-Time", 1);
    ...
    this.add("Carlos", "Boozer", [Player.POSITION_POWER_FORWARD], 85, "Chicago Bulls '10-'11", 1);
    this.add("Carlos", "Boozer", [Player.POSITION_POWER_FORWARD], 88, "Utah Jazz All-Time", 1);
    ...
    this.add("Charles", "Barkley", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 85, "Free Agency", 2);
    this.add("Charles", "Barkley", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 91, "Free Agency", 2);
    this.add("Charles", "Barkley", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 96, "Free Agency", 1);
    this.add("Charles", "Oakley", [Player.POSITION_POWER_FORWARD], 82, "Chicago Bulls '85-'86", 1);
    this.add("Charles", "Oakley", [Player.POSITION_POWER_FORWARD], 86, "New York Knicks All-Time", 1);
    ...
    this.add("Chris", "Mullin", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 89, "Golden State Warriors '90-'91", 1);
    this.add("Chris", "Mullin", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 94, "Golden State Warriors All-Time", 1);
    this.add("Chris", "Paul", [Player.POSITION_POINT_GUARD], 90, "Houston Rockets All-Time", 1);
    ...
    this.add("Clyde", "Drexler", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 89, "Free Agency", 1);
    ...
    this.add("David", "West", [Player.POSITION_POWER_FORWARD], 81, "Indiana Pacers '13-'14", 1);
    this.add("David", "West", [Player.POSITION_POWER_FORWARD], 86, "Free Agency", 1);
    this.add("David", "West", [Player.POSITION_POWER_FORWARD], 88, "New Orleans Pelicans All-Time", 1);
    this.add("De'Aaron", "Fox", [Player.POSITION_POINT_GUARD], 84, "Sacramento Kings All-Time", 1);
    ...
    this.add("Deandre", "Jordan", [Player.POSITION_CENTER], 87, "Los Angeles Clippers All-Time", 1);
    this.add("Dejounte", "Murray", [Player.POSITION_POINT_GUARD], 87, "San Antonio Spurs", 1);
    this.add("Dell", "Curry", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Charlotte Hornets All-Time", 1);
    this.add("Dell", "Curry", [Player.POSITION_SHOOTING_GUARD], 80, "Charlotte Hornets '92-'93", 1);
    this.add("Dennis", "Johnson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Boston Celtics '85-'86", 1);
    this.add("Dennis", "Johnson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 91, "Oklahoma City Thunder All-Time", 1);
    this.add("Dennis", "Johnson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 94, "Phoenix Suns All-Time", 1);
    this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 82, "Detroit Pistons '88-'89", 1);
    this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 85, "Chicago Bulls '97-'98", 1);
    this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 89, "Detroit Pistons All-Time", 1);
    this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 93, "Chicago Bulls All-Time", 1);
    ...
    this.add("Deron", "Williams", [Player.POSITION_POINT_GUARD], 87, "Utah Jazz All-Time", 1);
    this.add("Deron", "Williams", [Player.POSITION_POINT_GUARD], 91, "Free Agency");
    this.add("Derrick", "Coleman", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 86, "Charlotte Hornets All-Time", 1);
    this.add("Derrick", "Coleman", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 88, "Brooklyn Nets All-Time", 1);
    ...
    this.add("Devin", "Booker", [Player.POSITION_SHOOTING_GUARD], 89, "Phoenix Suns All-Time", 1);
    ...
    this.add("Dick", "Van Arsdale", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 88, "Phoenix Suns All-Time", 2);
    this.add("Dikembe", "Mutombo", [Player.POSITION_CENTER], 84, "Denver Nuggets '93-'94", 1);
    ...
    this.add("Doc", "Rivers", [Player.POSITION_POINT_GUARD], 83, "Atlanta Hawks '85-'86", 1);
    this.add("Doc", "Rivers", [Player.POSITION_POINT_GUARD], 86, "Atlanta Hawks All-Time", 1);
    ...
    this.add("Doug", "Collins", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Philadelphia 76ers '76-'77", 1);
    this.add("Doug", "Collins", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "Philadelphia 76ers All-Time", 1);
    this.add("Doug", "West", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Minnesota Timberwolves All-Time");
    this.add("Draymond", "Green", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 89, "Golden State Warriors All-Time", 2);
    ...
    this.add("Dwyane", "Wade", [Player.POSITION_SHOOTING_GUARD], 95, "Miami Heat '05-'06", 1);
    ...
    this.add("Fat", "Lever", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 92, "Denver Nuggets All-Time", 1);
    this.add("Fred", "Brown", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 81, "Free Agency", 1);
    this.add("Fred", "Brown", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 88, "Oklahoma City Thunder All-Time", 1);
    ...
    this.add("Gail", "Goodrich", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 83, "Los Angeles Lakers '70-'71", 1);
    this.add("Gail", "Goodrich", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 89, "Los Angeles Lakers All-Time", 1);
    this.add("Gary", "Payton", [Player.POSITION_POINT_GUARD], 83, "Los Angeles Lakers '03-'04", 1);
    this.add("Gary", "Payton", [Player.POSITION_POINT_GUARD], 95, "Oklahoma City Thunder All-Time", 1);
    this.add("Geoff", "Petrie", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 87, "Portland Trail Blazers All-Time");
    this.add("George", "Gervin", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 82, "Chicago Bulls '85-'86", 1);
    this.add("George", "Gervin", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 92, "Free Agency", 1);
    ...
    this.add("Glen", "Rice", [Player.POSITION_SMALL_FORWARD], 86, "Free Agency", 1);
    this.add("Glen", "Rice", [Player.POSITION_SMALL_FORWARD], 88, "Miami Heat All-Time", 1);
    this.add("Glen", "Rice", [Player.POSITION_SMALL_FORWARD], 90, "Charlotte Hornets All-Time", 1);
    ...
    this.add("Grant", "Hill", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 86, "Orlando Magic All-Time", 1);
    this.add("Grant", "Hill", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 93, "Detroit Pistons All-Time", 1);
    ...
    this.add("Hakeem", "Olajuwon", [Player.POSITION_CENTER], 94, "Free Agency", 1);
    ...
    this.add("J.R.", "Smith", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 80, "Free Agency", 1);
    ...
    this.add("Jack", "Sikma", [Player.POSITION_CENTER], 84, "Free Agency", 1);
    this.add("Jack", "Sikma", [Player.POSITION_CENTER], 89, "Oklahoma City Thunder All-Time", 1);
    this.add("Jae", "Crowder", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 81, "Phoenix Suns");
    this.add("Jalen", "Rose", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 86, "Free Agency", 1);
    ...
    this.add("James", "Harden", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 96, "Houston Rockets All-Time", 1);
    this.add("James", "Silas", [Player.POSITION_SHOOTING_GUARD], 86, "San Antonio Spurs All-Time");
    this.add("James", "Worthy", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 86, "Los Angeles Lakers '86-'87", 1);
    ...
    this.add("Jason", "Kidd", [Player.POSITION_POINT_GUARD], 87, "Dallas Mavericks All-Time", 1);
    this.add("Jason", "Kidd", [Player.POSITION_POINT_GUARD], 90, "Phoenix Suns All-Time", 1);
    this.add("Jason", "Kidd", [Player.POSITION_POINT_GUARD], 93, "New Jersey Nets '01-'02", 1);
    this.add("Jason", "Kidd", [Player.POSITION_POINT_GUARD], 96, "Brooklyn Nets All-Time", 1);
    ...
    this.add("Jerami", "Grant", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 83, "Detroit Pistons", 2);
    ...
    this.add("Jerry", "Stackhouse", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "Free Agency", 1);
    this.add("Jerry", "Stackhouse", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 89, "Detroit Pistons All-Time", 1);
    this.add("Jerry", "West", [Player.POSITION_POINT_GUARD], 93, "Los Angeles Lakers '64-'65", 1);
    this.add("Jerry", "West", [Player.POSITION_POINT_GUARD], 95, "Los Angeles Lakers '70-'71", 1);
    this.add("Jerry", "West", [Player.POSITION_POINT_GUARD], 97, "Los Angeles Lakers All-Time", 1);
    ...
    this.add("Jimmy", "Butler", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "Minnesota Timberwolves All-Time", 1);
    ...
    this.add("Joe", "Dumars", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 90, "Detroit Pistons '88-'89", 1);
    this.add("Joe", "Dumars", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 93, "Detroit Pistons All-Time", 1);
    this.add("Joe", "Johnson", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 83, "Phoenix Suns '04-'05", 1);
    ...
    this.add("John", "Stockton", [Player.POSITION_POINT_GUARD], 97, "Utah Jazz All-Time", 1);
    this.add("John", "Wall", [Player.POSITION_POINT_GUARD], 90, "Washington Wizards All-Time", 1);
    ...
    this.add("Julius", "Erving", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 95, "Philadelphia 76ers '76-'77", 1);
    ...
    this.add("Kareem", "Abdul-Jabbar", [Player.POSITION_CENTER], 84, "Free Agency", 1);
    this.add("Kareem", "Abdul-Jabbar", [Player.POSITION_CENTER], 94, "Los Angeles Lakers '86-'87", 1);
    ...
    this.add("Kawhi", "Leonard", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 92, "San Antonio Spurs '13-'14", 1);
    ...
    this.add("Kevin", "Duckworth", [Player.POSITION_CENTER], 85, "Portland Trail Blazers All-Time", 1);
    this.add("Kevin", "Durant", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 96, "Brooklyn Nets All-Time", 2);
    this.add("Kevin", "Durant", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 97, "Golden State Warriors All-Time", 2);
    this.add("Kevin", "Durant", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 97, "Oklahoma City Thunder All-Time", 2);
    this.add("Kevin", "Durant", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 99, "Free Agency");
    this.add("Kevin", "Garnett", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 83, "Free Agency", 2);
    this.add("Kevin", "Garnett", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 92, "Boston Celtics All-Time", 1);
    ...
    this.add("Klay", "Thompson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 92, "Golden State Warriors All-Time", 1);
    ...
    this.add("Kyle", "Lowry", [Player.POSITION_POINT_GUARD], 89, "Toronto Raptors All-Time", 1);
    ...
    this.add("LaMarcus", "Aldridge", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 86, "San Antonio Spurs All-Time", 1);
    this.add("LaMarcus", "Aldridge", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 89, "Portland Trail Blazers All-Time", 1);
    this.add("LaMelo", "Ball", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 86, "Charlotte Hornets", 1);
    this.add("Lamar", "Odom", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 82, "Los Angeles Clippers All-Time", 1);
    this.add("Lance", "Stephenson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 81, "Indiana Pacers '13-'14", 1);
    this.add("Laphonso", "Ellis", [Player.POSITION_POWER_FORWARD], 81, "Denver Nuggets '93-'94");
    this.add("Larry", "Bird", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 83, "Free Agency", 2);
    ...
    this.add("Larry", "Johnson", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 84, "Charlotte Hornets '92-'93", 1);
    this.add("Larry", "Johnson", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 88, "Charlotte Hornets All-Time", 1);
    ...
    this.add("LeBron", "James", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 99, "Cleveland Cavaliers All-Time", 1);
    this.add("LeBron", "James", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 99, "Miami Heat All-Time", 1);
    this.add("LeBron", "James", [Player.POSITION_SMALL_FORWARD], 84, "Free Agency", 1);
    this.add("LeBron", "James", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 99, "Free Agency", 1);
    this.add("Lionel", "Hollins", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Free Agency");
    this.add("Lonzo", "Ball", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 82, "New Orleans Pelicans All-Time", 1);
    ...
    this.add("Mahmoud", "Abdul-Rauf", [Player.POSITION_POINT_GUARD], 89, "Denver Nuggets All-Time", 1);
    this.add("Manu", "Ginobili", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 83, "San Antonio Spurs '13-'14", 1);
    this.add("Manu", "Ginobili", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "San Antonio Spurs '04-'05", 1);
    this.add("Manu", "Ginobili", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 90, "San Antonio Spurs All-Time", 1);
    ...
    this.add("Mark", "Jackson", [Player.POSITION_POINT_GUARD], 82, "Free Agency", 1);
    this.add("Mark", "Jackson", [Player.POSITION_POINT_GUARD], 85, "Indiana Pacers All-Time", 1);
    this.add("Mark", "Price", [Player.POSITION_POINT_GUARD], 89, "Cleveland Cavaliers '89-'90", 1);
    this.add("Mark", "Price", [Player.POSITION_POINT_GUARD], 93, "Cleveland Cavaliers All-Time", 1);
    this.add("Marques", "Johnson", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 92, "Milwaukee Bucks All-Time");
    this.add("Maurice", "Cheeks", [Player.POSITION_POINT_GUARD], 83, "Free Agency", 1);
    this.add("Maurice", "Cheeks", [Player.POSITION_POINT_GUARD], 86, "Philadelphia 76ers All-Time", 1);
    ...
    this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 84, "Free Agency", 1);
    this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 91, "Chicago Bulls '85-'86");
    this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 99, "Chicago Bulls All-Time", 1);
    this.add("Michael", "Redd", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 88, "Milwaukee Bucks All-Time");
    this.add("Micheal Ray", "Richardson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 89, "New York Knicks All-Time", 1);
    ...
    this.add("Mitch", "Richmond", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Golden State Warriors '90-'91", 1);
    this.add("Mitch", "Richmond", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 89, "Free Agency", 1);
    ...
    this.add("Moses", "Malone", [Player.POSITION_CENTER], 89, "Washington Wizards All-Time", 1);
    this.add("Moses", "Malone", [Player.POSITION_CENTER], 94, "Free Agency", 1);
    this.add("Moses", "Malone", [Player.POSITION_CENTER], 97, "Houston Rockets All-Time", 1);
    ...
    this.add("Nick", "Van Exel", [Player.POSITION_POINT_GUARD], 83, "Los Angeles Lakers '97-'98", 1);
    this.add("Nicolas", "Batum", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 83, "Portland Trail Blazers '09-'10", 1);
    ...
    this.add("Paul", "George", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 93, "Indiana Pacers All-Time", 1);
    this.add("Paul", "George", [Player.POSITION_SMALL_FORWARD], 88, "Free Agency", 1);
    this.add("Paul", "George", [Player.POSITION_SMALL_FORWARD], 94, "Oklahoma City Thunder All-Time", 1);
    ...
    this.add("Penny", "Hardaway", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 85, "Orlando Magic '94-'95", 1);
    ...
    this.add("R.J.", "Barrett", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 85, "New York Knicks", 1);
    ...
    this.add("Rasheed", "Wallace", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 86, "Detroit Pistons '03-'04", 1);
    ...
    this.add("Rick", "Barry", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 95, "Golden State Warriors All-Time", 1);
    ...
    this.add("Rik", "Smits", [Player.POSITION_CENTER], 83, "Free Agency", 1);
    this.add("Rik", "Smits", [Player.POSITION_CENTER], 87, "Indiana Pacers All-Time", 1);
    ...
    this.add("Rudy", "Gobert", [Player.POSITION_CENTER], 88, "Utah Jazz All-Time", 1);
    ...
    this.add("Russell", "Westbrook", [Player.POSITION_POINT_GUARD], 89, "Oklahoma City Thunder '11-'12", 1);
    this.add("Russell", "Westbrook", [Player.POSITION_POINT_GUARD], 95, "Oklahoma City Thunder All-Time", 1);
    this.add("Sam", "Cassell", [Player.POSITION_POINT_GUARD], 82, "Free Agency", 1);
    this.add("Sam", "Cassell", [Player.POSITION_POINT_GUARD], 88, "Minnesota Timberwolves All-Time", 1);
    this.add("Sam", "Jones", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 88, "Boston Celtics '64-'65", 1);
    this.add("Sam", "Jones", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 92, "Boston Celtics All-Time", 1);
    ...
    this.add("Scottie", "Pippen", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 82, "Chicago Bulls '88-'89", 2);
    ...
    this.add("Scottie", "Pippen", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 95, "Chicago Bulls '95-'96", 1);
    ...
    this.add("Serge", "Ibaka", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 81, "Toronto Raptors All-Time", 1);
    this.add("Serge", "Ibaka", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 87, "Oklahoma City Thunder '11-'12", 2);
    ...
    this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 83, "Free Agency", 1);
    this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 89, "Miami Heat All-Time", 1);
    ...
    this.add("Shareef", "Abdur-Rahim", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 84, "Free Agency", 1);
    this.add("Shareef", "Abdur-Rahim", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 86, "Memphis Grizzlies All-Time", 1);
    ...
    this.add("Shawn", "Marion", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 83, "Dallas Mavericks '10-'11", 1);
    this.add("Shawn", "Marion", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 87, "Phoenix Suns '04-'05", 1);
    this.add("Shawn", "Marion", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 91, "Phoenix Suns All-Time", 1);
    this.add("Sidney", "Moncrief", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 90, "Milwaukee Bucks '84-'85", 1);
    this.add("Sidney", "Moncrief", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 93, "Milwaukee Bucks All-Time", 1);
    ...
    this.add("Stephen", "Jackson", [Player.POSITION_SMALL_FORWARD], 83, "Charlotte Hornets All-Time", 1);
    ...
    this.add("Steve", "Francis", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 85, "Orlando Magic All-Time", 1);
    this.add("Steve", "Francis", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 88, "Houston Rockets All-Time", 1);
    this.add("Steve", "Nash", [Player.POSITION_POINT_GUARD], 87, "Dallas Mavericks All-Time", 1);
    this.add("Steve", "Nash", [Player.POSITION_POINT_GUARD], 95, "Phoenix Suns '04-'05", 1);
    ...
    this.add("Swen", "Nater", [Player.POSITION_CENTER], 88, "Los Angeles Clippers All-Time", 1);
    this.add("Taj", "Gibson", [Player.POSITION_POWER_FORWARD], 80, "Free Agency", 1);
    this.add("Tayshaun", "Prince", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 81, "Free Agency", 1);
    ...
    this.add("Tim", "Duncan", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 88, "San Antonio Spurs '97-'98", 1);
    this.add("Tim", "Duncan", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 98, "San Antonio Spurs All-Time", 1);
    this.add("Tim", "Hardaway", [Player.POSITION_POINT_GUARD], 87, "Golden State Warriors '90-'91", 1);
    this.add("Tim", "Hardaway", [Player.POSITION_POINT_GUARD], 89, "Miami Heat All-Time", 1);
    this.add("Tim", "Hardaway", [Player.POSITION_POINT_GUARD], 91, "Golden State Warriors All-Time", 1);
    this.add("Tom", "Chambers", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 89, "Phoenix Suns All-Time");
    this.add("Tom", "Gugliotta", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 84, "Free Agency", 1);
    this.add("Tom", "Gugliotta", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 88, "Minnesota Timberwolves All-Time", 1);
    this.add("Tom", "Heinsohn", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 81, "Boston Celtics '64-'65", 1);
    this.add("Tom", "Heinsohn", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 89, "Boston Celtics All-Time", 1);
    this.add("Tom", "Sanders", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 85, "Boston Celtics '64-'65");
    this.add("Toni", "Kukoc", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 83, "Chicago Bulls '95-'96", 2);
    this.add("Toni", "Kukoc", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 85, "Chicago Bulls All-Time", 2);
    this.add("Tony", "Allen", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Memphis Grizzlies All-Time");
    this.add("Tony", "Parker", [Player.POSITION_POINT_GUARD], 86, "San Antonio Spurs '13-'14", 1);
    ...
    this.add("Tracy", "McGrady", [Player.POSITION_SHOOTING_GUARD], 83, "Toronto Raptors '99-'00", 1);
    ...
    this.add("Tyson", "Chandler", [Player.POSITION_CENTER], 87, "New York Knicks '11-'12", 1);
    ...
    this.add("Vlade", "Divac", [Player.POSITION_CENTER], 82, "Free Agency", 2);
    this.add("Vlade", "Divac", [Player.POSITION_CENTER], 85, "Charlotte Hornets All-Time", 1);
    this.add("Vlade", "Divac", [Player.POSITION_CENTER], 88, "Sacramento Kings All-Time", 2);
    this.add("Wally", "Szczerbiak", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 85, "Minnesota Timberwolves All-Time", 1);
    ...
    this.add("Wes", "Unseld", [Player.POSITION_POWER_FORWARD], 82, "Free Agency", 1);
    ...
    this.add("Yao", "Ming", [Player.POSITION_CENTER], 88, "Houston Rockets '07-'08", 1);
    ...
    this.add("Zach", "Randolph", [Player.POSITION_POWER_FORWARD], 86, "Portland Trail Blazers All-Time", 1);
