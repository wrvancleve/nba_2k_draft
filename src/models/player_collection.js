...
PlayerCollection.prototype.populateAllTime = function() {
    ...
    this.add("Wilt", "Chamberlain", [Player.POSITION_CENTER], 99, "Golden State Warriors All-Time");
    this.add("Stephen", "Curry", [Player.POSITION_POINT_GUARD], 98, "Golden State Warriors All-Time");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Mitch", "Richmond", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 88, "Golden State Warriors All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Anthony", "Edwards", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 91, "Minnesota Timberwolves All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Shai", "Gilgeous-Alexander", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 93, "Oklahoma City Thunder All-Time");
    if (!this.onlySingleVersion)
    ...
    this.add("Tony", "Parker", [Player.POSITION_POINT_GUARD], 95, "San Antonio Spurs All-Time");
    if (!this.onlySingleVersion)
        this.add("Kawhi", "Leonard", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 95, "San Antonio Spurs All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Victor", "Wembanyama", [Player.POSITION_CENTER], 86, "San Antonio Spurs All-Time");
    ...
    this.add("Hakeem", "Olajuwon", [Player.POSITION_CENTER], 99, "Houston Rockets All-Time");
    ...
    this.add("Scottie", "Barnes", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 86, "Toronto Raptors All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Jrue", "Holiday", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 86, "New Orleans Pelicans All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Tyrese", "Haliburton", [Player.POSITION_POINT_GUARD], 87, "Indiana Pacers All-Time");
    ...
    this.add("Jamal", "Murray", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 87, "Denver Nuggets All-Time");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Vince", "Carter", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 90, "Brooklyn Nets All-Time");
    if (!this.onlySingleVersion)
        this.add("Kyrie", "Irving", [Player.POSITION_POINT_GUARD], 89, "Brooklyn Nets All-Time");
    if (!this.onlySingleVersion)
        this.add("James", "Harden", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 89, "Brooklyn Nets All-Time");
    ...
    this.add("Dwight", "Howard", [Player.POSITION_CENTER], 94, "Orlando Magic All-Time");
    if (!this.onlySingleVersion)
        this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 93, "Orlando Magic All-Time");
    if (!this.onlySingleVersion)
        this.add("Paolo", "Banchero", [Player.POSITION_POWER_FORWARD], 87, "Orlando Magic All-Time");
    ...
    this.add("Kobe", "Bryant", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 99, "Los Angeles Lakers All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Pau", "Gasol", [Player.POSITION_CENTER], 91, "Los Angeles Lakers All-Time");
    ...
    this.add("Domantas", "Sabonis", [Player.POSITION_CENTER], 88, "Sacramento Kings All-Time");
    ...
    if (!this.onlySingleVersion)
        this.add("Lamelo", "Ball", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 86, "Charlotte Hornets All-Time");
    ...
    this.add("Hassan", "Whiteside", [Player.POSITION_CENTER], 84, "Miami Heat All-Time");
    ...
    this.add("Jeff", "Teague", [Player.POSITION_POINT_GUARD], 85, "Atlanta Hawks All-Time");
    if (!this.onlySingleVersion)
    ...
    this.add("Paul", "George", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 89, "Los Angeles Clippers All-Time");
    this.add("World B.", "Free", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 89, "Los Angeles Clippers All-Time");
    ...
    this.add("Larry", "Bird", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 99, "Boston Celtics All-Time");
    ...
    this.add("Jaylen", "Brown", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 91, "Boston Celtics All-Time");
    ...
    this.add("Sidney", "Moncrief", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 94, "Milwaukee Bucks All-Time");
    ...
    this.add("Tyrese", "Maxey", [Player.POSITION_POINT_GUARD], 89, "Philadelphia 76ers All-Time");
...
PlayerCollection.prototype.populateExtended = function() {
    this.add("Bill", "Russell", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 99, "Free Agency");
    this.add("Charles", "Barkley", [Player.POSITION_POWER_FORWARD], 97, "Free Agency");
    this.add("Reggie", "Miller", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 95, "Free Agency");
    if (!this.onlySingleVersion)
        this.add("Devin", "Booker", [Player.POSITION_SHOOTING_GUARD], 95, "Free Agency");
    if (!this.onlySingleVersion)
        this.add("Ja", "Morant", [Player.POSITION_POINT_GUARD], 94, "Free Agency");
    this.add("Blake", "Griffin", [Player.POSITION_POWER_FORWARD], 93, "Free Agency");
    this.add("Klay", "Thompson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 92, "Free Agency");
    this.add("Chris", "Bosh", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 91, "Free Agency");
    this.add("Zion", "Williamson", [Player.POSITION_POWER_FORWARD], 90, "Free Agency");
    this.add("Trae", "Young", [Player.POSITION_POINT_GUARD], 90, "Free Agency");
    this.add("Bradley", "Beal", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 90, "Free Agency");
    this.add("John", "Wall", [Player.POSITION_POINT_GUARD], 90, "Free Agency");
    if (!this.onlySingleVersion)
        this.add("Jalen", "Williams", [Player.POSITION_SMALL_FORWARD], 89, "Oklahoma City Thunder");
    this.add("Andre", "Iguodala", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 88, "Free Agency");
    this.add("Serge", "Ibaka", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 87, "Free Agency");
...
PlayerCollection.prototype.populateClassic = function() {
    ...
    if (!this.onlySingleVersion)
        this.add("Klay", "Thompson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 91, "Golden State Warriors '16-'17");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Tim", "Duncan", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 92, "San Antonio Spurs '13-'14");
    if (!this.onlySingleVersion)
        this.add("Kawhi", "Leonard", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 92, "San Antonio Spurs '13-'14");
    if (!this.onlySingleVersion)
        this.add("Tony", "Parker", [Player.POSITION_POINT_GUARD], 85, "San Antonio Spurs '13-'14");
    if (!this.onlySingleVersion)
        this.add("Manu", "Ginobili", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 83, "San Antonio Spurs '13-'14");
    this.add("Danny", "Green", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 81, "San Antonio Spurs '13-'14");
    
    if (!this.onlySingleVersion)
        this.add("Dwyane", "Wade", [Player.POSITION_SHOOTING_GUARD], 91, "Miami Heat '12-'13");
    if (!this.onlySingleVersion)
        this.add("Chris", "Bosh", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 85, "Miami Heat '12-'13");
    
    if (!this.onlySingleVersion)
        this.add("Marc", "Gasol", [Player.POSITION_CENTER], 88, "Memphis Grizzlies '12-'13");
    if (!this.onlySingleVersion)
        this.add("Mike", "Conley", [Player.POSITION_POINT_GUARD], 86, "Memphis Grizzlies '12-'13");
    if (!this.onlySingleVersion)
        this.add("Zach", "Randolph", [Player.POSITION_POWER_FORWARD], 85, "Memphis Grizzlies '12-'13");
    
    if (!this.onlySingleVersion)
        this.add("Kevin", "Durant", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 96, "Oklahoma City Thunder '11-'12");
    if (!this.onlySingleVersion)
        this.add("Russell", "Westbrook", [Player.POSITION_POINT_GUARD], 88, "Oklahoma City Thunder '11-'12");
    if (!this.onlySingleVersion)
    ...
    this.add("Luol", "Deng", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 82, "Chicago Bulls '10-'11");
    ...
    if (!this.onlySingleVersion)
        this.add("Allen", "Iverson", [Player.POSITION_POINT_GUARD], 88, "Denver Nuggets '07-'08");
    ...
    if (!this.onlySingleVersion)
        this.add("Baron", "Davis", [Player.POSITION_POINT_GUARD], 88, "Golden State Warriors '06-'07");
    this.add("Al", "Harrington", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 83, "Golden State Warriors '06-'07");
    this.add("Monta", "Ellis", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 81, "Golden State Warriors '06-'07");
    if (!this.onlySingleVersion)
        this.add("Jason", "Richardson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 80, "Golden State Warriors '06-'07");
    if (!this.onlySingleVersion)
        this.add("Stephen", "Jackson", [Player.POSITION_SMALL_FORWARD], 80, "Golden State Warriors '06-'07");
    
    if (!this.onlySingleVersion)
        this.add("LeBron", "James", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 96, "Cleveland Cavaliers '06-'07");
    if (!this.onlySingleVersion)
        this.add("Zydrunas", "Ilgauskas", [Player.POSITION_CENTER], 81, "Cleveland Cavaliers '06-'07");
    this.add("Larry", "Hughes", [Player.POSITION_POINT_GUARD], 80, "Cleveland Cavaliers '06-'07");
    
    if (!this.onlySingleVersion)
        this.add("Dwyane", "Wade", [Player.POSITION_SHOOTING_GUARD], 95, "Miami Heat '05-'06");
    
    if (!this.onlySingleVersion)
        this.add("Pau", "Gasol", [Player.POSITION_CENTER], 90, "Memphis Grizzlies '05-'06");
    if (!this.onlySingleVersion)
        this.add("Shane", "Battier", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 82, "Memphis Grizzlies '05-'06");
    if (!this.onlySingleVersion)
        this.add("Mike", "Miller", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 80, "Memphis Grizzlies '05-'06");
    
    if (!this.onlySingleVersion)
        this.add("Steve", "Nash", [Player.POSITION_POINT_GUARD], 95, "Phoenix Suns '04-'05");
    if (!this.onlySingleVersion)
        this.add("Amar'e", "Stoudemire", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 88, "Phoenix Suns '04-'05");
    if (!this.onlySingleVersion)
        this.add("Shawn", "Marion", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 87, "Phoenix Suns '04-'05");
    if (!this.onlySingleVersion)
        this.add("Joe", "Johnson", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 80, "Phoenix Suns '04-'05");
    
    if (!this.onlySingleVersion)
        this.add("Tony", "Parker", [Player.POSITION_POINT_GUARD], 89, "San Antonio Spurs '04-'05");
    if (!this.onlySingleVersion)
        this.add("Manu", "Ginobili", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 86, "San Antonio Spurs '04-'05");
    if (!this.onlySingleVersion)
        this.add("Bruce", "Bowen", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 83, "San Antonio Spurs '04-'05");
    ...
    if (!this.onlySingleVersion)
        this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 94, "Los Angeles Lakers '03-'04");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Stephon", "Marbury", [Player.POSITION_POINT_GUARD], 84, "Phoenix Suns '02-'03");
    if (!this.onlySingleVersion)
        this.add("Amar'e", "Stoudemire", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 80, "Phoenix Suns '02-'03");
    ...
    if (!this.onlySingleVersion)
        this.add("Nick", "Van Exel", [Player.POSITION_POINT_GUARD], 81, "Dallas Mavericks '02-'03");
    if (!this.onlySingleVersion)
        this.add("Michael", "Finley", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 81, "Dallas Mavericks '02-'03");
    
    if (!this.onlySingleVersion)
        this.add("Jason", "Kidd", [Player.POSITION_POINT_GUARD], 92, "New Jersey Nets '01-'02");
    if (!this.onlySingleVersion)
        this.add("Keith", "Van Horn", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 82, "New Jersey Nets '01-'02");
    if (!this.onlySingleVersion)
        this.add("Kenyon", "Martin", [Player.POSITION_POWER_FORWARD], 82, "New Jersey Nets '01-'02");
    this.add("Kerry", "Kittles", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 81, "New Jersey Nets '01-'02");
    
    if (!this.onlySingleVersion)
        this.add("Peja", "Stojakovic", [Player.POSITION_SMALL_FORWARD], 86, "Sacramento Kings '01-'02");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Mike", "Bibby", [Player.POSITION_POINT_GUARD], 82, "Sacramento Kings '01-'02");
    
    if (!this.onlySingleVersion)
        this.add("Kobe", "Bryant", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 98, "Los Angeles Lakers '00-'01");
    if (!this.onlySingleVersion)
        this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 96, "Los Angeles Lakers '00-'01");
    if (!this.onlySingleVersion)
        this.add("Horace", "Grant", [Player.POSITION_POWER_FORWARD], 80, "Los Angeles Lakers '00-'01");
    
    if (!this.onlySingleVersion)
        this.add("Allen", "Iverson", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 93, "Philadelphia 76ers '00-'01");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Tim", "Duncan", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 87, "San Antonio Spurs '97-'98");
    ...
    this.add("Nick", "Van Exel", [Player.POSITION_POINT_GUARD], 82, "Los Angeles Lakers '97-'98");
    ...
    if (!this.onlySingleVersion)
        this.add("Scottie", "Pippen", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 88, "Chicago Bulls '97-'98");
    if (!this.onlySingleVersion)
        this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 84, "Chicago Bulls '97-'98");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Gary", "Payton", [Player.POSITION_POINT_GUARD], 92, "Seattle SuperSonics '95-'96");
    if (!this.onlySingleVersion)
        this.add("Shawn", "Kemp", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 88, "Seattle SuperSonics '95-'96");
    if (!this.onlySingleVersion)
        this.add("Detlef", "Schrempf", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 84, "Seattle SuperSonics '95-'96");
    ...
    if (!this.onlySingleVersion)
        this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 87, "Chicago Bulls '95-'96");
    if (!this.onlySingleVersion)
        this.add("Toni", "Kukoc", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 83, "Chicago Bulls '95-'96");
    
    if (!this.onlySingleVersion)
        this.add("Shaquille", "O'Neal", [Player.POSITION_CENTER], 92, "Orlando Magic '94-'95");
    if (!this.onlySingleVersion)
        this.add("Penny", "Hardaway", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Orlando Magic '94-'95");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Dennis", "Scott", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 80, "Orlando Magic '94-'95");
    ...
    if (!this.onlySingleVersion)
        this.add("Charles", "Oakley", [Player.POSITION_POWER_FORWARD], 80, "New York Knicks '94-'95");
    ...
    if (!this.onlySingleVersion)
        this.add("Laphonso", "Ellis", [Player.POSITION_POWER_FORWARD], 80, "Denver Nuggets '93-'94");
    ...
    if (!this.onlySingleVersion)
        this.add("Alonzo", "Mourning", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 86, "Charlotte Hornets '92-'93");
    if (!this.onlySingleVersion)
        this.add("Larry", "Johnson", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 83, "Charlotte Hornets '92-'93");
    if (!this.onlySingleVersion)
        this.add("Muggsy", "Bogues", [Player.POSITION_POINT_GUARD], 80, "Charlotte Hornets '92-'93");
    
    if (!this.onlySingleVersion)
        this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 99, "Chicago Bulls '92-'93");
    if (!this.onlySingleVersion)
        this.add("Scottie", "Pippen", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 92, "Chicago Bulls '92-'93");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Clyde", "Drexler", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 90, "Portland Trail Blazers '90-'91");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("James", "Worthy", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 86, "Los Angeles Lakers '90-'91");
    
    if (!this.onlySingleVersion)
        this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 97, "Chicago Bulls '90-'91");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Larry", "Nance", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 86, "Cleveland Cavaliers '89-'90");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Dennis", "Rodman", [Player.POSITION_POWER_FORWARD], 81, "Detroit Pistons '88-'89");
    this.add("Vinnie", "Johnson", [Player.POSITION_POINT_GUARD], 81, "Detroit Pistons '88-'89");
    if (!this.onlySingleVersion)
        this.add("Bill", "Laimbeer", [Player.POSITION_CENTER], 80, "Detroit Pistons '88-'89");
    
    if (!this.onlySingleVersion)
        this.add("Magic", "Johnson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 96, "Los Angeles Lakers '86-'87");
    if (!this.onlySingleVersion)
        this.add("Kareem", "Abdul-Jabbar", [Player.POSITION_CENTER], 94, "Los Angeles Lakers '86-'87");
    if (!this.onlySingleVersion)
        this.add("James", "Worthy", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 85, "Los Angeles Lakers '86-'87");
    if (!this.onlySingleVersion)
        this.add("Michael", "Cooper", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 85, "Los Angeles Lakers '86-'87");
    if (!this.onlySingleVersion)
        this.add("Byron", "Scott", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 82, "Los Angeles Lakers '86-'87");
    this.add("A.C.", "Green", [Player.POSITION_POWER_FORWARD], 81, "Los Angeles Lakers '86-'87");
    
    if (!this.onlySingleVersion)
        this.add("Dominique", "Wilkins", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 90, "Atlanta Hawks '85-'86");
    if (!this.onlySingleVersion)
        this.add("Doc", "Rivers", [Player.POSITION_POINT_GUARD], 84, "Atlanta Hawks '85-'86");
    
    if (!this.onlySingleVersion)
        this.add("Larry", "Bird", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 98, "Boston Celtics '85-'86");
    if (!this.onlySingleVersion)
        this.add("Kevin", "McHale", [Player.POSITION_POWER_FORWARD], 91, "Boston Celtics '85-'86");
    if (!this.onlySingleVersion)
        this.add("Robert", "Parish", [Player.POSITION_CENTER], 85, "Boston Celtics '85-'86");
    if (!this.onlySingleVersion)
        this.add("Dennis", "Johnson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Boston Celtics '85-'86");
    if (!this.onlySingleVersion)
        this.add("Bill", "Walton", [Player.POSITION_CENTER], 81, "Boston Celtics '85-'86");
    
    if (!this.onlySingleVersion)
        this.add("Michael", "Jordan", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 90, "Chicago Bulls '85-'86");
    if (!this.onlySingleVersion)
        this.add("George", "Gervin", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 82, "Chicago Bulls '85-'86");
    if (!this.onlySingleVersion)
        this.add("Charles", "Oakley", [Player.POSITION_POWER_FORWARD], 81, "Chicago Bulls '85-'86");
    ...
    this.add("Paul", "Pressey", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Milwaukee Bucks '84-'85");
    
    if (!this.onlySingleVersion)
        this.add("Julius", "Erving", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 94, "Philadelphia 76ers '76-'77");
    if (!this.onlySingleVersion)
    ...
    this.add("Henry", "Bibby", [Player.POSITION_POINT_GUARD], 80, "Philadelphia 76ers '76-'77");
    if (!this.onlySingleVersion)
        this.add("World B.", "Free", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 80, "Philadelphia 76ers '76-'77");
    
    if (!this.onlySingleVersion)
        this.add("Walt", "Frazier", [Player.POSITION_POINT_GUARD], 92, "New York Knicks '71-'72");
    if (!this.onlySingleVersion)
        this.add("Jerry", "Lucas", [Player.POSITION_POWER_FORWARD], 86, "New York Knicks '71-'72");
    if (!this.onlySingleVersion)
        this.add("Dave", "DeBusschere", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 84, "New York Knicks '71-'72");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Wilt", "Chamberlain", [Player.POSITION_CENTER], 92, "Los Angeles Lakers '70-'71");
    if (!this.onlySingleVersion)
        this.add("Gail", "Goodrich", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 84, "Los Angeles Lakers '70-'71");

    if (!this.onlySingleVersion)
        this.add("Kareem", "Abdul-Jabbar", [Player.POSITION_CENTER], 97, "Milwaukee Bucks '70-'71");
    if (!this.onlySingleVersion)
        this.add("Oscar", "Robertson", [Player.POSITION_POINT_GUARD], 92, "Milwaukee Bucks '70-'71");
    if (!this.onlySingleVersion)
    ...
    if (!this.onlySingleVersion)
        this.add("Elgin", "Baylor", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 91, "Los Angeles Lakers '64-'65");
    if (!this.onlySingleVersion)
...
PlayerCollection.prototype.populateCurrent = function() {
    if (!this.onlySingleVersion)
        this.add("Stephen", "Curry", [Player.POSITION_POINT_GUARD], 95, "Golden State Warriors");

    this.add("Deandre", "Ayton", [Player.POSITION_CENTER], 83, "Portland Trail Blazers");
    this.add("Jerami", "Grant", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 82, "Portland Trail Blazers");

    this.add("Anthony", "Edwards", [Player.POSITION_SHOOTING_GUARD], 93, "Minnesota Timberwolves");

    this.add("Shai", "Gilgeous-Alexander", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 96, "Oklahoma City Thunder");
    this.add("Chet", "Holmgren", [Player.POSITION_CENTER], 87, "Oklahoma City Thunder");
    this.add("Jalen", "Williams", [Player.POSITION_SMALL_FORWARD], 86, "Oklahoma City Thunder");

    this.add("Devin", "Booker", [Player.POSITION_SHOOTING_GUARD], 93, "Phoenix Suns");
    if (!this.onlySingleVersion)
        this.add("Bradley", "Beal", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 85, "Phoenix Suns");

    this.add("Victor", "Wembanyama", [Player.POSITION_CENTER], 91, "San Antonio Spurs");

    this.add("Jalen", "Green", [Player.POSITION_SHOOTING_GUARD], 84, "Houston Rockets");

    this.add("Cade", "Cunningham", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 86, "Detroit Pistons");

    this.add("Dejounte", "Murray", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 86, "New Orleans Pelicans");

    this.add("Tyrese", "Haliburton", [Player.POSITION_POINT_GUARD], 90, "Indiana Pacers");
    this.add("Pascal", "Siakam", [Player.POSITION_POWER_FORWARD], 88, "Indiana Pacers");
    this.add("Myles", "Turner", [Player.POSITION_CENTER], 84, "Indiana Pacers");

    this.add("Michael", "Porter Jr.", [Player.POSITION_SMALL_FORWARD], 83, "Denver Nuggets");

    this.add("Luka", "Doncic", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 97, "Dallas Mavericks");
    if (!this.onlySingleVersion)
        this.add("Kyrie", "Irving", [Player.POSITION_POINT_GUARD], 92, "Dallas Mavericks");

    this.add("Paolo", "Banchero", [Player.POSITION_POWER_FORWARD], 89, "Orlando Magic");

    this.add("Austin", "Reaves", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 81, "Los Angeles Lakers");

    this.add("Jalen", "Brunson", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 93, "New York Knicks");
    this.add("Mikal", "Bridges", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 84, "New York Knicks");
    this.add("OG", "Anunoby", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 84, "New York Knicks");
    this.add("Josh", "Hart", [Player.POSITION_SMALL_FORWARD], 82, "New York Knicks");

    this.add("De'Aaron", "Fox", [Player.POSITION_POINT_GUARD], 88, "Sacramento Kings");
    this.add("Malik", "Monk", [Player.POSITION_SHOOTING_GUARD], 80, "Sacramento Kings");

    this.add("Lauri", "Markkanen", [Player.POSITION_POWER_FORWARD], 86, "Utah Jazz");

    this.add("LaMelo", "Ball", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 87, "Charlotte Hornets");

    this.add("Bam", "Adebayo", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 88, "Miami Heat");

    if (!this.onlySingleVersion)
        this.add("Trae", "Young", [Player.POSITION_POINT_GUARD], 89, "Atlanta Hawks");
    this.add("Clint", "Capela", [Player.POSITION_CENTER], 80, "Atlanta Hawks");

    this.add("Ja", "Morant", [Player.POSITION_POINT_GUARD], 90, "Memphis Grizzlies");
    this.add("Jaren", "Jackson Jr.", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 87, "Memphis Grizzlies");

    this.add("Jayson", "Tatum", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 95, "Boston Celtics");
    this.add("Jaylen", "Brown", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 92, "Boston Celtics");
    this.add("Jrue", "Holiday", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 87, "Boston Celtics");
    this.add("Kristaps", "Porzingis", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 87, "Boston Celtics");
    
    this.add("Donovan", "Mitchell", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_POINT_GUARD], 92, "Cleveland Cavaliers");
    this.add("Evan", "Mobley", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 86, "Cleveland Cavaliers");
    this.add("Jarrett", "Allen", [Player.POSITION_CENTER], 84, "Cleveland Cavaliers");
    this.add("Darius", "Garland", [Player.POSITION_POINT_GUARD], 82, "Cleveland Cavaliers");

    if (!this.onlySingleVersion)
        this.add("Damian", "Lillard", [Player.POSITION_POINT_GUARD], 89, "Milwaukee Bucks");
    if (!this.onlySingleVersion)
