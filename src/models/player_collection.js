...
PlayerCollection.prototype.populateAllTime = function() {
    ...
    if (!this.onlySingleVersion) {
        this.add("Devin", "Booker", [Player.POSITION_SHOOTING_GUARD], 88, "Phoenix Suns All-Time");
    }
    ...
    if (!this.onlySingleVersion) {
        this.add("Joel", "Embiid", [Player.POSITION_CENTER], 92, "Philadelphia 76ers All-Time");
    }
    ...
    this.add("Nikola", "Jokic", [Player.POSITION_CENTER], 93, "Denver Nuggets All-Time");
...
PlayerCollection.prototype.populateCurrent = function() {
    if (!this.onlySingleVersion) {
        this.add("Andrew", "Wiggins", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 84, "Golden State Warriors");
        this.add("Anthony", "Davis", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 90, "Los Angeles Lakers");
    }
    this.add("Anthony", "Edwards", [Player.POSITION_SHOOTING_GUARD], 86, "Minnesota Timberwolves");
    this.add("Bam", "Adebayo", [Player.POSITION_CENTER, Player.POSITION_POWER_FORWARD], 87, "Miami Heat");
    if (!this.onlySingleVersion) {
        this.add("Ben", "Simmons", [Player.POSITION_POINT_GUARD, Player.POSITION_POWER_FORWARD], 83, "Brooklyn Nets");
        this.add("Bradley", "Beal", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "Washington Wizards");
    }
    this.add("Cade", "Cunningham", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Detroit Pistons");
    this.add("Clint", "Capela", [Player.POSITION_CENTER], 84, "Atlanta Hawks");
    this.add("D'Angelo", "Russell", [Player.POSITION_POINT_GUARD], 82, "Minnesota Timberwolves");
    if (!this.onlySingleVersion) {
        this.add("Damian", "Lillard", [Player.POSITION_POINT_GUARD], 89, "Portland Trail Blazers");
    }
    this.add("Darius", "Garland", [Player.POSITION_POINT_GUARD], 87, "Cleveland Cavaliers");
    this.add("Deandre", "Ayton", [Player.POSITION_CENTER], 85, "Phoenix Suns");
    this.add("Dejounte", "Murray", [Player.POSITION_POINT_GUARD], 86, "Atlanta Hawks");
    this.add("Devin", "Booker", [Player.POSITION_SHOOTING_GUARD], 91, "Phoenix Suns");
    if (!this.onlySingleVersion) {
        this.add("Draymond", "Green", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 83, "Golden State Warriors");
    }
    this.add("Evan", "Mobley", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 84, "Cleveland Cavaliers");
    this.add("Giannis", "Antetokounmpo", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 97, "Milwaukee Bucks");
    this.add("Ja", "Morant", [Player.POSITION_POINT_GUARD], 93, "Memphis Grizzlies");
    if (!this.onlySingleVersion) {
        this.add("Jalen", "Green", [Player.POSITION_SHOOTING_GUARD], 82, "Houston Rockets");
    }
    this.add("Jarrett", "Allen", [Player.POSITION_CENTER], 85, "Cleveland Cavaliers");
    if (!this.onlySingleVersion) {
        this.add("Jaylen", "Brown", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 87, "Boston Celtics");
    }
    this.add("Jayson", "Tatum", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 93, "Boston Celtics");
    if (!this.onlySingleVersion) {
        this.add("Jerami", "Grant", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 82, "Portland Trail Blazers");
    }
    this.add("Jimmy", "Butler", [Player.POSITION_SHOOTING_GUARD, Player.POSITION_SMALL_FORWARD], 93, "Miami Heat");
    ...
    if (!this.onlySingleVersion) {
        this.add("Jordan", "Poole", [Player.POSITION_SHOOTING_GUARD], 83, "Golden State Warriors");
    }
    this.add("Josh", "Giddey", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 82, "Oklahoma City Thunder");
    if (!this.onlySingleVersion) {
        this.add("Khris", "Middleton", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 86, "Milwaukee Bucks");
        this.add("Kristaps", "Porzingis", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 85, "Washington Wizards");
    ...
    this.add("Marcus", "Smart", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 82, "Boston Celtics");
    if (!this.onlySingleVersion) {
        this.add("Michael", "Porter Jr.", [Player.POSITION_SMALL_FORWARD], 80, "Denver Nuggets");
    }
    this.add("Mikal", "Bridges", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 83, "Phoenix Suns");
    this.add("Myles", "Turner", [Player.POSITION_CENTER], 82, "Indiana Pacers");
    this.add("Nikola", "Jokic", [Player.POSITION_CENTER], 96, "Denver Nuggets");
    if (!this.onlySingleVersion) {
        this.add("OG", "Anunoby", [Player.POSITION_SMALL_FORWARD, Player.POSITION_POWER_FORWARD], 81, "Toronto Raptors");
        this.add("Paul", "George", [Player.POSITION_SMALL_FORWARD], 88, "Los Angeles Clippers");
    }
    this.add("R.J.", "Barrett", [Player.POSITION_SMALL_FORWARD, Player.POSITION_SHOOTING_GUARD], 84, "New York Knicks");
    this.add("Robert", "Williams III", [Player.POSITION_POWER_FORWARD, Player.POSITION_CENTER], 85, "Boston Celtics");
    if (!this.onlySingleVersion) {
        this.add("Scottie", "Barnes", [Player.POSITION_POWER_FORWARD, Player.POSITION_SMALL_FORWARD], 84, "Toronto Raptors");
        this.add("Shai", "Gilgeous-Alexander", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 87, "Oklahoma City Thunder");
    }    
    this.add("Steven", "Adams", [Player.POSITION_CENTER], 82, "Memphis Grizzlies");
    this.add("Trae", "Young", [Player.POSITION_POINT_GUARD], 90, "Atlanta Hawks");
    if (!this.onlySingleVersion) {
        this.add("Tyler", "Herro", [Player.POSITION_SHOOTING_GUARD], 84, "Miami Heat");
    }
    this.add("Tyrese", "Haliburton", [Player.POSITION_POINT_GUARD, Player.POSITION_SHOOTING_GUARD], 84, "Indiana Pacers");
    this.add("Tyrese", "Maxey", [Player.POSITION_POINT_GUARD], 85, "Philadelphia 76ers");
    this.add("Zach", "LaVine", [Player.POSITION_SHOOTING_GUARD], 88, "Chicago Bulls");
}
